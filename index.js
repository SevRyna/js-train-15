...
function generateRandomPassword(length) {
  ...
  for (let i = 0; i < length; i++) {
    ...
    ind = Math.random() * arrLen;
    randKey = Math.floor(ind);
...
function roundObjectValues(obj) {
  ...
  if (typeof obj !== "object") {
    ...
    // Якщо аргумент не є об'єктом або є null, виводимо повідомлення "Помилка: аргумент має бути об'єктом".if(!Array.isArray(numbers)){
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  if (!Array.isArray(products)) {
    ...
    console.log("products має бути масивом");
    // Повертаємо null, що свідчить про неможливість обробки вхідних даних.
    return null;
  }
  ...
  if (typeof maxPrice !== "number") {
    ...
    console.log("maxPrice має буди числом");
    // Повертаємо null, що свідчить про неможливість обробки вхідних даних.
    return null;
  }
